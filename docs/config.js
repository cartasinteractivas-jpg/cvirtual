...
window.CVIRTUAL_CONFIG = {
  ...
  assetsBaseUrl: "/manus-storage/",
  // URL de la Edge Function que recibe el formulario sin exponer service_role.
  registrationEndpoint: "https://wpzddhmllctdsiuxenss.supabase.co/functions/v1/register-profile",
